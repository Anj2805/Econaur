                ...
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-xl font-normal text-[#0d2f2f]">
                            Manage all service locations in the system
                        </p>
                    </div>
                    <a href="{{ route('admin.locations.create') }}" class="bg-[#0d2f2f] text-white px-6 py-3 rounded-lg hover:bg-[#0a2525] transition-colors duration-300">
                        Add New Location
                    </a>
                </div>
            </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('admin.locations.edit', $location->id) }}" class="text-[#0d2f2f] hover:text-[#0a2525] mr-3">Edit</a>
