            ...
            <div class="p-10 text-gray-900">
                <div class="text-center">
                    ...
                    <p class="text-xl font-normal text-[#0d2f2f]">
                        Manage all demo requests in the system
                    </p>
                </div>
            </div>
        </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $request->service->name }}</td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('admin.demo-requests.show', $request->id) }}" class="text-[#0d2f2f] hover:text-[#0a2525] mr-3">View</a>
                                @if($request->status === 'pending')
                                <form action="{{ route('admin.demo-requests.update-status', $request->id) }}" method="POST" class="inline">
                                    @csrf
                                    @method('PATCH')
